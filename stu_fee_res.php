...
include 'cons.php';
$sql="select  `aun`, `date`, `sub`, `msg` FROM `feed_res` where student='$us'";
...
<body>
    ...
    <div style="border:2px solid white;background-color:#1e272e;color:white;margin:20px 200px;text-align:left;border-radius:40px;padding:2px 20px;" behavior="alternate" scrollamount="10">
        <h1 style="text-align:center; color: rgba(89, 156, 230, 0.9)">Feedback Responce </h1>

        <form method="post">
            <table width="60%" cellpadding="5" cellspacing="0">
              
                <tr style="color:rgba(230, 155, 78, 0.94)">
                    <th>Sender</th>
                    <th>Date</th>
                    <th>Subject</th>
                    <th>Message</th>
